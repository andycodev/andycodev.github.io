<template>
  <div
    class="col-span-12 md:col-span-8 p-6 bg-white border border-gray-200 rounded-lg shadow mt-2 hidden sm:block transition-opacity duration-500 ease-in-out">
